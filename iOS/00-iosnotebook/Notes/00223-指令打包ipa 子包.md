...
#找到开发者签名
nwfSign='24FE094332AC66D3D023B8AA6CD4950AB3386393'
...
#执行文件名称 projName 改为 项目名称即可
#需要配置的变量
#产品名称
productName= 'projName' #'projName'
#绝对路径
pathFirst='/Users/dwight/Desktop/tabletest'
#执行文件
nwfExecutableFile='projName'
#包文件
payAppDirectory='/Payload/projName.app'
#存放子包的文件夹
subPackage='package'
mkdir ${subPackage}
