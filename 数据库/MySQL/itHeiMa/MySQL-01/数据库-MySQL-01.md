- [数据库开发-MySQL](#数据库开发-mysql)
  ...
  - [1. MySQL概述](#1-mysql概述)
    - [1.1 安装](#11-安装)
      ...
      - [1.1.2 安装](#112-安装)
      - [1.1.3 连接](#113-连接)
      - [1.1.4 企业使用方式(了解)](#114-企业使用方式了解)
    - [1.2 数据模型](#12-数据模型)
    - [1.3 SQL简介](#13-sql简介)
      - [1.3.1 SQL通用语法](#131-sql通用语法)
      - [1.3.2 分类](#132-分类)
  - [2. 数据库设计-DDL](#2-数据库设计-ddl)
    - [2.1 项目开发流程](#21-项目开发流程)
    - [2.2 数据库操作](#22-数据库操作)
      - [2.2.1 查询数据库](#221-查询数据库)
      - [2.2.2 创建数据库](#222-创建数据库)
      - [2.2.3 使用数据库](#223-使用数据库)
      - [2.2.4 删除数据库](#224-删除数据库)
    - [2.3 图形化工具](#23-图形化工具)
      - [2.3.1 介绍](#231-介绍)
      - [2.3.2 安装](#232-安装)
      - [2.3.3 使用](#233-使用)
        - [2.2.3.1 连接数据库](#2231-连接数据库)
        - [2.2.3.2 操作数据库](#2232-操作数据库)
    - [2.3 表操作](#23-表操作)
      - [2.3.1 创建](#231-创建)
        - [2.3.1.1 语法](#2311-语法)
        - [2.3.1.2 约束](#2312-约束)
        - [2.3.1.3 数据类型](#2313-数据类型)
        - [2.3.1.4 案例](#2314-案例)
        - [2.3.1.5 设计表流程](#2315-设计表流程)
      - [2.3.2 查询](#232-查询)
      - [2.3.3 修改](#233-修改)
      - [2.3.4 删除](#234-删除)
  - [3. 数据库操作-DML](#3-数据库操作-dml)
    - [3.1 增加(insert)](#31-增加insert)
    - [3.2 修改(update)](#32-修改update)
    - [3.3 删除(delete)](#33-删除delete)
