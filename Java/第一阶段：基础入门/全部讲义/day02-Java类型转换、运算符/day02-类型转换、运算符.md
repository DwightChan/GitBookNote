- [day02——数据类型、运算符](#day02数据类型运算符)
  - [一、数据的表示详解](#一数据的表示详解)
    - [1.1 整数在计算机中的存储原理](#11-整数在计算机中的存储原理)
    - [1.2 字符在计算机中的存储原理](#12-字符在计算机中的存储原理)
    - [1.3 图片视频声音的存储原理](#13-图片视频声音的存储原理)
    - [1.4 数据的其他表示形式](#14-数据的其他表示形式)
    - [1.5 不同进制在Java程序中的书写格式](#15-不同进制在java程序中的书写格式)
  - [二、数据类型详解](#二数据类型详解)
  - [三、数据类型转换](#三数据类型转换)
  ...
  - [四、运算符](#四运算符)
    - [3.1 算术运算符](#31-算术运算符)
    - [3. 2 自增自减运算符](#3-2-自增自减运算符)
    - [3.3 赋值运算符](#33-赋值运算符)
    - [3.4 关系运算符](#34-关系运算符)
    - [3.5 逻辑运算符](#35-逻辑运算符)
    - [3.6 三元运算符](#36-三元运算符)
    - [3.7 运算优先级](#37-运算优先级)
  - [五、案例技术：获取用户键盘输入的数据](#五案例技术获取用户键盘输入的数据)
