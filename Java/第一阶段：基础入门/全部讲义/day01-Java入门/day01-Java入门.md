- [day01 ——Java基础入门](#day01-java基础入门)
  - [一、 Java背景知识](#一-java背景知识)
    - [1.1 Java语言的历史](#11-java语言的历史)
    - [1.2 Java能做什么](#12-java能做什么)
    - [1.3 Java的技术体系](#13-java的技术体系)
  - [二、 Java快速入门](#二-java快速入门)
    - [2.1 JDK下载和安装](#21-jdk下载和安装)
    - [2.2 cmd常见命令](#22-cmd常见命令)
    - [2.3 Java入门程序](#23-java入门程序)
    - [2.4 Java程序中常见的问题](#24-java程序中常见的问题)
    - [2.5 JDK的组成](#25-jdk的组成)
    - [2.6 Java的跨平台原理](#26-java的跨平台原理)
    - [2.7 JDK环境变量配置](#27-jdk环境变量配置)
  - [三、Java开发工具](#三java开发工具)
    - [3.1 IDEA下载和安装](#31-idea下载和安装)
    - [3.2 IDEA编写Java程序](#32-idea编写java程序)
    - [3.4 IDEA各种配置](#34-idea各种配置)
    - [3.5 常用快捷键](#35-常用快捷键)
  - [四. Java基础语法](#四-java基础语法)
    - [4.1 注释](#41-注释)
    - [4.2 字面量](#42-字面量)
    - [4.3 变量](#43-变量)
    - [4.4 关键字](#44-关键字)
