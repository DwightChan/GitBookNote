- [day07——面向对象基础](#day07面向对象基础)
  - [一、面向对象入门](#一面向对象入门)
  - [二、深刻认识面向对象](#二深刻认识面向对象)
    - [2.1 面向对象编程有什么好处？](#21-面向对象编程有什么好处)
    - [2.2 程序中对象到底是个啥？](#22-程序中对象到底是个啥)
    - [2.3 对象是怎么出来的？](#23-对象是怎么出来的)
  - [三、对象在计算机中的执行原理](#三对象在计算机中的执行原理)
  - [四、类和对象的一些注意事项](#四类和对象的一些注意事项)
  - [五、this关键字](#五this关键字)
  - [六、构造器](#六构造器)
  - [七、封装性](#七封装性)
  - [八、实体JavaBean](#八实体javabean)
  - [九、面向对象综合案例](#九面向对象综合案例)
    - [1. 第一步：定义电影类](#1-第一步定义电影类)
    - [2. 第二步：定义电影操作类](#2-第二步定义电影操作类)
    - [3. 第三步：定义测试类](#3-第三步定义测试类)
  - [十、成员变量和局部变量的区别](#十成员变量和局部变量的区别)
