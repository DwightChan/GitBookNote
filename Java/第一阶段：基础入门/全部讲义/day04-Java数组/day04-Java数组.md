- [day04——Java数组](#day04java数组)
  - [一、认识数组](#一认识数组)
    - [1. 什么数组](#1-什么数组)
    - [2. 数组的应用场景](#2-数组的应用场景)
  - [二、数组的定义和访问](#二数组的定义和访问)
    - [2.1 数组的静态初始化](#21-数组的静态初始化)
    - [2.2 数组的元素访问](#22-数组的元素访问)
    - [2.3 数组的遍历](#23-数组的遍历)
    - [2.4 数组静态初始化案例](#24-数组静态初始化案例)
    - [2.5 数组的动态初始化](#25-数组的动态初始化)
    - [2.6 数组动态初始化案例](#26-数组动态初始化案例)
  - [三、数组在计算机中的执行原理](#三数组在计算机中的执行原理)
    - [3.1 数组的执行原理，Java程序的执行原理](#31-数组的执行原理java程序的执行原理)
    - [3.2 多个变量指向同一个数组的问题](#32-多个变量指向同一个数组的问题)
  - [四、数组专项练习](#四数组专项练习)
    - [4.1 数组求最值](#41-数组求最值)
    - [4.2 数组元素反转](#42-数组元素反转)
    - [4.3 随机排名](#43-随机排名)
  - [五、Debug调试工具](#五debug调试工具)
