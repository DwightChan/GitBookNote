...
- [1. Mybatis基础操作](#1-mybatis基础操作)
  - [1.1 需求](#11-需求)
  - [1.2 准备](#12-准备)
  - [1.3 删除](#13-删除)
    - [1.3.1 功能实现](#131-功能实现)
    - [1.3.2 日志输入](#132-日志输入)
    - [1.3.3 预编译SQL](#133-预编译sql)
      - [1.3.3.1 介绍](#1331-介绍)
      - [1.3.3.2 SQL注入](#1332-sql注入)
      - [1.3.3.3 参数占位符](#1333-参数占位符)
  - [1.4 新增](#14-新增)
    - [1.4.1 基本新增](#141-基本新增)
    - [1.4.2 主键返回](#142-主键返回)
  - [1.5 更新](#15-更新)
  - [1.6 查询](#16-查询)
    - [1.6.1 根据ID查询](#161-根据id查询)
    - [1.6.2 数据封装](#162-数据封装)
    - [1.6.3 条件查询](#163-条件查询)
    - [1.6.4 参数名说明](#164-参数名说明)
- [2. Mybatis的XML配置文件](#2-mybatis的xml配置文件)
  - [2.1 XML配置文件规范](#21-xml配置文件规范)
  - [2.2 XML配置文件实现](#22-xml配置文件实现)
  - [2.3 MybatisX的使用](#23-mybatisx的使用)
- [3. Mybatis动态SQL](#3-mybatis动态sql)
  - [3.1 什么是动态SQL](#31-什么是动态sql)
  - [3.2 动态SQL-if](#32-动态sql-if)
    - [3.2.1 条件查询](#321-条件查询)
    - [3.2.2 更新员工](#322-更新员工)
  - [3.3 动态SQL-foreach](#33-动态sql-foreach)
  - [3.4 动态SQL-sql\&include](#34-动态sql-sqlinclude)
