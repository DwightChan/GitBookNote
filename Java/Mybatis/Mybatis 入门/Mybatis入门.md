- [Mybatis入门](#mybatis入门)
  - [前言](#前言)
  - [1. 快速入门](#1-快速入门)
    - [1.1 入门程序分析](#11-入门程序分析)
    - [1.2 入门程序实现](#12-入门程序实现)
      - [1.2.1 准备工作](#121-准备工作)
        - [1.2.1.1 创建springboot工程](#1211-创建springboot工程)
        - [1.2.1.2 数据准备](#1212-数据准备)
      - [1.2.2 配置Mybatis](#122-配置mybatis)
      - [1.2.3 编写SQL语句](#123-编写sql语句)
      - [1.2.4 单元测试](#124-单元测试)
    - [1.3 解决SQL警告与提示](#13-解决sql警告与提示)
  - [2. JDBC介绍(了解)](#2-jdbc介绍了解)
    - [2.1 介绍](#21-介绍)
    - [2.2 代码](#22-代码)
    - [2.3 问题分析](#23-问题分析)
    - [2.4 技术对比](#24-技术对比)
