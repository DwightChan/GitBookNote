- [苍穹外卖-day02](#苍穹外卖-day02)
  - [课程内容](#课程内容)
  - [1. 新增员工](#1-新增员工)
    - [1.1 需求分析和设计](#11-需求分析和设计)
      - [1.1.1 产品原型](#111-产品原型)
      - [1.1.2 接口设计](#112-接口设计)
      - [1.1.3 表设计](#113-表设计)
    - [1.2 代码开发](#12-代码开发)
      - [1.2.1 设计DTO类](#121-设计dto类)
      - [1.2.2 Controller层](#122-controller层)
      - [1.2.3 Service层接口](#123-service层接口)
      - [1.2.4 Service层实现类](#124-service层实现类)
      - [1.2.5 Mapper层](#125-mapper层)
    - [1.3 功能测试](#13-功能测试)
      - [1.3.1 接口文档测试](#131-接口文档测试)
      - [1.3.2 前后端联调测试](#132-前后端联调测试)
    - [1.4 代码完善](#14-代码完善)
      - [1.4.1 问题一](#141-问题一)
      - [1.4.2 问题二](#142-问题二)
      - [1.4.3 ThreadLocal](#143-threadlocal)
    - [1.5 代码提交](#15-代码提交)
  - [2. 员工分页查询](#2-员工分页查询)
    - [2.1 需求分析和设计](#21-需求分析和设计)
      - [2.1.1 产品原型](#211-产品原型)
      - [2.1.2 接口设计](#212-接口设计)
    - [2.2 代码开发](#22-代码开发)
      - [2.2.1 设计DTO类](#221-设计dto类)
      - [2.2.2 封装PageResult](#222-封装pageresult)
      - [2.2.3 Controller层](#223-controller层)
      - [2.2.4 Service层接口](#224-service层接口)
      - [2.2.5 Service层实现类](#225-service层实现类)
      - [2.2.6 Mapper层](#226-mapper层)
    - [2.3 功能测试](#23-功能测试)
      - [2.3.1 接口文档测试](#231-接口文档测试)
      - [2.3.2 前后端联调测试](#232-前后端联调测试)
    - [2.4 代码完善](#24-代码完善)
    - [2.5 代码提交](#25-代码提交)
  - [3. 启用禁用员工账号](#3-启用禁用员工账号)
    - [3.1 需求分析与设计](#31-需求分析与设计)
      - [3.1.1 产品原型](#311-产品原型)
      - [3.1.2 接口设计](#312-接口设计)
    - [3.2 代码开发](#32-代码开发)
      - [3.2.1 Controller层](#321-controller层)
      - [3.2.2 Service层接口](#322-service层接口)
      - [3.2.3 Service层实现类](#323-service层实现类)
      - [3.2.4 Mapper层](#324-mapper层)
    - [3.3 功能测试](#33-功能测试)
      - [3.3.1 接口文档测试](#331-接口文档测试)
      - [3.3.2 前后端联调测试](#332-前后端联调测试)
    - [3.4 代码提交](#34-代码提交)
  - [4. 编辑员工](#4-编辑员工)
    - [4.1 需求分析与设计](#41-需求分析与设计)
      - [4.1.1 产品原型](#411-产品原型)
      - [4.1.2 接口设计](#412-接口设计)
    - [4.2 代码开发](#42-代码开发)
      - [4.2.1 回显员工信息功能](#421-回显员工信息功能)
      - [4.2.2 修改员工信息功能](#422-修改员工信息功能)
    - [4.3 功能测试](#43-功能测试)
      - [4.3.1 接口文档测试](#431-接口文档测试)
      - [4.3.2 前后端联调测试](#432-前后端联调测试)
    - [4.4 代码提交](#44-代码提交)
  - [5. 导入分类模块功能代码](#5-导入分类模块功能代码)
    - [5.1 需求分析与设计](#51-需求分析与设计)
      - [5.1.1 产品原型](#511-产品原型)
      - [5.1.2 接口设计](#512-接口设计)
      - [5.1.3 表设计](#513-表设计)
    - [5.2 代码导入](#52-代码导入)
      - [5.2.1 Mapper层](#521-mapper层)
      - [5.2.2 Service层](#522-service层)
      - [5.2.3 Controller层](#523-controller层)
    - [5.3 功能测试](#53-功能测试)
    - [5.4 代码提交](#54-代码提交)
...
```java
    ...
    public void save(EmployeeDTO employeeDTO) {
        ...
        //对象属性拷贝 （前后两个对象属性名称一致 可以通过此方法快速设置）
...
```java
    ...
    protected void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        //将自己的消息转化器加入容器中 （插在第一个位置优先使用，如果默认添加在最后，则是可能不会被用到）
