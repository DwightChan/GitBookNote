- [苍穹外卖-day08](#苍穹外卖-day08)
  - [课程内容](#课程内容)
  - [1. 导入地址簿功能代码](#1-导入地址簿功能代码)
    - [1.1 需求分析和设计](#11-需求分析和设计)
      - [1.1.1 产品原型](#111-产品原型)
      - [1.1.2 接口设计](#112-接口设计)
      - [1.1.3 表设计](#113-表设计)
    - [1.2 代码导入](#12-代码导入)
      - [1.2.1 Mapper层](#121-mapper层)
      - [1.2.2 Service层](#122-service层)
      - [1.2.3 Controller层](#123-controller层)
    - [1.3 功能测试](#13-功能测试)
    - [1.4 代码提交](#14-代码提交)
  - [2. 用户下单](#2-用户下单)
    ...
    - [2.4 代码提交](#24-代码提交)
  - [3. 订单支付](#3-订单支付)
    - [3.1 微信支付介绍](#31-微信支付介绍)
    - [3.2 微信支付准备工作](#32-微信支付准备工作)
      - [3.2.1 如何保证数据安全？](#321-如何保证数据安全)
      - [3.2.2 如何调用到商户系统？](#322-如何调用到商户系统)
    - [3.3 代码导入](#33-代码导入)
      - [3.3.1 微信支付相关配置](#331-微信支付相关配置)
      - [3.3.2 Mapper层](#332-mapper层)
      - [3.3.3 Service层](#333-service层)
      - [3.3.4 Controller层](#334-controller层)
    - [3.4 功能测试](#34-功能测试)
    - [3.5 代码提交](#35-代码提交)
