- [苍穹外卖-day05](#苍穹外卖-day05)
  - [课程内容](#课程内容)
  - [1. Redis入门](#1-redis入门)
    - [1.1 Redis简介](#11-redis简介)
    - [1.2 Redis下载与安装](#12-redis下载与安装)
      - [1.2.1 Redis下载](#121-redis下载)
      - [1.2.2 Redis安装](#122-redis安装)
    - [1.3 Redis服务启动与停止](#13-redis服务启动与停止)
      - [1.3.1 服务启动命令](#131-服务启动命令)
      - [1.3.2 客户端连接命令](#132-客户端连接命令)
      - [1.3.3 修改Redis配置文件](#133-修改redis配置文件)
      - [1.3.4 Redis客户端图形工具](#134-redis客户端图形工具)
  - [2. Redis数据类型](#2-redis数据类型)
    - [2.1 五种常用数据类型介绍](#21-五种常用数据类型介绍)
    - [2.2 各种数据类型特点](#22-各种数据类型特点)
  - [3. Redis常用命令](#3-redis常用命令)
    - [3.1 字符串操作命令](#31-字符串操作命令)
    - [3.2 哈希操作命令](#32-哈希操作命令)
    - [3.3 列表操作命令](#33-列表操作命令)
    - [3.4 集合操作命令](#34-集合操作命令)
    - [3.5 有序集合操作命令](#35-有序集合操作命令)
    - [3.6 通用命令](#36-通用命令)
  - [4.在Java中操作Redis](#4在java中操作redis)
    - [4.1 Redis的Java客户端](#41-redis的java客户端)
    - [4.2 Spring Data Redis使用方式](#42-spring-data-redis使用方式)
      - [4.2.1 介绍](#421-介绍)
      - [4.2.2 环境搭建](#422-环境搭建)
      - [4.2.3 操作常见类型数据](#423-操作常见类型数据)
  - [5. 店铺营业状态设置](#5-店铺营业状态设置)
    - [5.1 需求分析和设计](#51-需求分析和设计)
      - [5.1.1 产品原型](#511-产品原型)
      - [5.1.2 接口设计](#512-接口设计)
      - [5.1.3 营业状态存储方式](#513-营业状态存储方式)
    - [5.2 代码开发](#52-代码开发)
      - [5.2.1 设置营业状态](#521-设置营业状态)
      - [5.2.2 管理端查询营业状态](#522-管理端查询营业状态)
      - [5.2.3 用户端查询营业状态](#523-用户端查询营业状态)
    - [5.3 功能测试](#53-功能测试)
      - [5.3.1 接口文档测试](#531-接口文档测试)
      - [5.3.2 接口分组展示](#532-接口分组展示)
      - [5.3.3 前后端联调测试](#533-前后端联调测试)
    - [5.4 代码提交](#54-代码提交)
