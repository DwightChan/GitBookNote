- [day08-Map集合、Stream流、File类](#day08-map集合stream流file类)
  - [一、Map集合](#一map集合)
    - [1.1 HashMap](#11-hashmap)
    - [1.2 LinkedHashMap](#12-linkedhashmap)
    - [1.3 TreeMap](#13-treemap)
    - [1.4 集合嵌套](#14-集合嵌套)
  - [二、JDK8新特性（Stream流）](#二jdk8新特性stream流)
    - [2.1 Stream流体验](#21-stream流体验)
    - [2.2 Stream流的创建](#22-stream流的创建)
    - [2.3 Stream流中间方法](#23-stream流中间方法)
    - [2.5 Stream流终结方法](#25-stream流终结方法)
  - [三、File类](#三file类)
    - [3.1 File对象的创建](#31-file对象的创建)
    - [3.2 File判断和获取方法](#32-file判断和获取方法)
    - [3.3 创建和删除方法](#33-创建和删除方法)
    - [3.4 遍历文件夹方法](#34-遍历文件夹方法)
  - [四、递归](#四递归)
    - [4.1 递归算法引入](#41-递归算法引入)
    - [4.2 递归算法的执行流程](#42-递归算法的执行流程)
    - [4.3 递归文件搜索](#43-递归文件搜索)
