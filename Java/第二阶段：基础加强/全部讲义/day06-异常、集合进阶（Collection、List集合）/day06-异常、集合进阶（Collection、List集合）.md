- [day06—集合进阶（异常、集合）](#day06集合进阶异常集合)
  - [一、异常](#一异常)
    - [1.1 认识异常](#11-认识异常)
    - [1.2 自定义异常](#12-自定义异常)
    - [1.3 异常处理](#13-异常处理)
  - [二、集合概述和分类](#二集合概述和分类)
    - [2.1 集合的分类](#21-集合的分类)
    - [2.2 Collection集合的常用方法](#22-collection集合的常用方法)
  - [三、Collection遍历方式](#三collection遍历方式)
    - [3.1 迭代器遍历集合](#31-迭代器遍历集合)
    - [3.2 增强for遍历集合](#32-增强for遍历集合)
    - [3.3 forEach遍历集合](#33-foreach遍历集合)
    - [3.4 遍历集合案例](#34-遍历集合案例)
  - [四、List系列集合](#四list系列集合)
    - [4.1 List集合的常用方法](#41-list集合的常用方法)
    - [4.2 List集合的遍历方式](#42-list集合的遍历方式)
    - [4.3 ArrayList底层的原理](#43-arraylist底层的原理)
    - [4.4 LinkedList底层原理](#44-linkedlist底层原理)
    - [4.5 LinkedList集合的应用场景](#45-linkedlist集合的应用场景)
