- [day03——面向对象高级](#day03面向对象高级)
  ...
  - [二、枚举](#二枚举)
    - [2.1 认识枚举](#21-认识枚举)
    - [2.2 枚举的应用场景](#22-枚举的应用场景)
  - [三、泛型](#三泛型)
    - [3.1 认识泛型](#31-认识泛型)
    - [3.2 自定义泛型类](#32-自定义泛型类)
    - [3.3 自定义泛型接口](#33-自定义泛型接口)
    - [3.4 泛型方法](#34-泛型方法)
    - [3.5 泛型限定](#35-泛型限定)
    - [3.6 泛型擦除](#36-泛型擦除)
  - [四、常用API](#四常用api)
    - [4.1 Object类](#41-object类)
    - [4.2 Objects类](#42-objects类)
    - [4.3 基本类型包装类](#43-基本类型包装类)
