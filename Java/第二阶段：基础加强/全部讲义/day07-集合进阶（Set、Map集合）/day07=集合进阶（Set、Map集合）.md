- [day07——集合进阶（Set、Map集合）](#day07集合进阶setmap集合)
  - [一、Set系列集合](#一set系列集合)
    - [1.1 认识Set集合的特点](#11-认识set集合的特点)
    - [1.2 HashSet集合底层原理](#12-hashset集合底层原理)
    - [1.3 HashSet去重原理](#13-hashset去重原理)
    - [1.4 LinkedHashSet底层原理](#14-linkedhashset底层原理)
    - [1.5 TreeSet集合](#15-treeset集合)
    - [1.6 总结Collection集合](#16-总结collection集合)
    - [1.7 并发修改异常](#17-并发修改异常)
  - [二、Collection的其他操作](#二collection的其他操作)
    - [2.1 可变参数](#21-可变参数)
    - [2.2 Collections工具类](#22-collections工具类)
    - [2.3 斗地主案例](#23-斗地主案例)
  - [三、Map集合](#三map集合)
    - [3.1 Map概述体系](#31-map概述体系)
    - [3.2 Map集合的常用方法](#32-map集合的常用方法)
    - [3.3 Map集合遍历方式1](#33-map集合遍历方式1)
    - [3.4 Map集合遍历方式2](#34-map集合遍历方式2)
    - [3.5 Map集合遍历方式3](#35-map集合遍历方式3)
    - [3.6 Map集合案例](#36-map集合案例)
