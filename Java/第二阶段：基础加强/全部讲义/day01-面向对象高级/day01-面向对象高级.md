- [day01——面向对象高级](#day01面向对象高级)
  - [一、静态](#一静态)
    - [1.1 static修饰成员变量](#11-static修饰成员变量)
    - [1.2 static修饰成员变量的应用场景](#12-static修饰成员变量的应用场景)
    - [1.3 static修饰成员方法](#13-static修饰成员方法)
    - [1.4 工具类](#14-工具类)
    - [1.5 static的注意事项](#15-static的注意事项)
    - [1.6 static应用（代码块）](#16-static应用代码块)
    - [1.7 static应用（单例设计模式）](#17-static应用单例设计模式)
  - [二、继承](#二继承)
    - [2.1 继承快速入门](#21-继承快速入门)
    - [2.2 继承的好处](#22-继承的好处)
    - [2.3 权限修饰符](#23-权限修饰符)
    - [2.4 单继承、Object](#24-单继承object)
    - [2.5 方法重写](#25-方法重写)
    - [2.6 子类中访问成员的特点](#26-子类中访问成员的特点)
    - [2.7 子类中访问构造器的特点](#27-子类中访问构造器的特点)
