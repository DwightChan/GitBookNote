- [day09-字符集、IO流（一）](#day09-字符集io流一)
  - [一、字符集](#一字符集)
    - [1.1 字符集的来历](#11-字符集的来历)
    - [1.2 汉字和字母的编码特点](#12-汉字和字母的编码特点)
    - [1.3 Unicode字符集](#13-unicode字符集)
    - [1.4 字符集小结](#14-字符集小结)
    - [1.5 编码和解码](#15-编码和解码)
  - [二、IO流（字节流）](#二io流字节流)
    - [2.1 IO流概述](#21-io流概述)
    - [2.2 FileInputStream读取一个字节](#22-fileinputstream读取一个字节)
    - [2.3 FileInputStream读取多个字节](#23-fileinputstream读取多个字节)
    - [2.4 FileInputStream读取全部字节](#24-fileinputstream读取全部字节)
    - [2.5 FileOutputStream写字节](#25-fileoutputstream写字节)
    - [2.6 字节流复制文件](#26-字节流复制文件)
  - [三、IO流资源释放](#三io流资源释放)
    - [3.1 JDK7以前的资源释放](#31-jdk7以前的资源释放)
    - [3.2 JDK7以后的资源释放](#32-jdk7以后的资源释放)
