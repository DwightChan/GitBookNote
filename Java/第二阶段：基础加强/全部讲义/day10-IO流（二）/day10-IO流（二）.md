- [day10-IO流（二）](#day10-io流二)
  - [一、字符流](#一字符流)
    - [1.1 FileReader类](#11-filereader类)
    - [1.2 FileWriter类](#12-filewriter类)
    - [1.3 FileWriter写的注意事项](#13-filewriter写的注意事项)
  - [二、缓冲流](#二缓冲流)
    - [2.1 缓冲字节流](#21-缓冲字节流)
    - [2.2 字符缓冲流](#22-字符缓冲流)
    - [2.3 缓冲流性能分析](#23-缓冲流性能分析)
  - [三、转换流](#三转换流)
    - [3.1 InputStreamReader类](#31-inputstreamreader类)
    - [3.2 OutputStreamWriter类](#32-outputstreamwriter类)
  - [四、打印流](#四打印流)
    - [4.1 打印流基本使用](#41-打印流基本使用)
    - [4.2 重定向输出语句](#42-重定向输出语句)
  - [五、数据流](#五数据流)
    - [5.1 DataOutputStream类](#51-dataoutputstream类)
    - [5.2 DataInputStream类](#52-datainputstream类)
  - [六、序列化流](#六序列化流)
    - [6.1 ObjectOutputStraem类](#61-objectoutputstraem类)
    - [6.2 ObjectInputStream类](#62-objectinputstream类)
  - [七、补充知识：IO框架](#七补充知识io框架)
