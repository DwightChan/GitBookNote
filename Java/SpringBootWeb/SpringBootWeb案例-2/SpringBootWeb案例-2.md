- [SpringBootWeb案例](#springbootweb案例)
  ...
  - [3. 修改员工](#3-修改员工)
    - [3.1 查询回显](#31-查询回显)
      ...
      - [3.1.2 实现思路](#312-实现思路)
      - [3.1.3 代码实现](#313-代码实现)
      - [3.1.4 postman测试](#314-postman测试)
    - [3.2 修改员工](#32-修改员工)
      - [3.2.1 接口文档](#321-接口文档)
      - [3.2.2 实现思路](#322-实现思路)
      - [3.2.3 代码实现](#323-代码实现)
      - [3.2.4 postman测试](#324-postman测试)
      - [3.2.5 前后端联调测试](#325-前后端联调测试)
  - [4. 配置文件](#4-配置文件)
    - [4.1 参数配置化](#41-参数配置化)
    - [4.2 yml配置文件](#42-yml配置文件)
    - [4.3 @ConfigurationProperties](#43-configurationproperties)
